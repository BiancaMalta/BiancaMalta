...
| ------- | ------- | ------- |
| [Observability](https://github.com/BiancaMalta/Observability) | Projeto implementando conceitos de observabilidade | em andamento |
| [AWS](https://github.com/BiancaMalta/Amazon-Web-Services) | Durante o quarto módulo do programa de capacitação DevOps da B3 em parceria com a Ada Tech, desenvolvemos algumas atividades de AWS. Nesse diretório, organizei em pastas os arquivos de cada atividade e deixei uma breve explicação sobre o tema.| em andamento |
