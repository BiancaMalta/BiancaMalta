...
| ------- | ------- | ------- |
| [CloudFileShare](https://github.com/BiancaMalta/Projeto-AWS) | Uma aplicação Flask dockerizada se integra com MySQL e Amazon S3 para armazenamento de dados e arquivos. Possui funcionalidades de upload, armazenamento de relatórios e exibição, além de uma função Lambda para desligar instâncias EC2 via CloudWatch EventBridge. | ok |
| [Observability](https://github.com/BiancaMalta/Observability) | Projeto implementando conceitos de observabilidade. | ok |
| [AWS](https://github.com/BiancaMalta/Amazon-Web-Services) | Durante o quarto módulo do programa de capacitação DevOps da B3 em parceria com a Ada Tech, desenvolvemos algumas atividades de AWS. Nesse diretório, organizei em pastas os arquivos de cada atividade e deixei uma breve explicação sobre o tema.| ok |
